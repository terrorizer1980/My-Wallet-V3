...
function insertWallet (guid, sharedKey, password, extra, decryptWalletProgress, sessionToken) {
  ...
  var dataPromise = new Promise(function (resolve, reject) {
    ...
    var crypted = WalletCrypto.encryptWallet(data, password, MyWallet.wallet.defaultPbkdf2Iterations, MyWallet.wallet.isUpgradedToHD ? MyWallet.wallet.isUpgradedToV4 || SHOULD_PERFORM_V4_UPGRADE ? 4.0 : 3.0 : 2.0);
